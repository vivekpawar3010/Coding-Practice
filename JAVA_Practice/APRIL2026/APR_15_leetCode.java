// 3917. Count Indices With Opposite Parity Solved Easy premium lock icon Companies Hint You are given an integer array nums of length n.

// The score of an index i is defined as the number of indices j such that:

// i<j<n,and nums[i]and nums[j]have different parity(one is even and the other is odd).Return an integer array answer of length n,where answer[i]is the score of index i.
...
public class APR_15_leetCode {
    public static void main(String[] args) {
        int[] nums = { 1, 2, 3, 4 };
        int[] result = Solution.countOppositeParity(nums);
